...
<svg xmlns="http://www.w3.org/2000/svg" width="512" height="512" viewBox="0 0 512 512">
  <defs>
    <linearGradient id="bg" x1="0" y1="0" x2="1" y2="1">
      <stop offset="0" stop-color="#2e5d7a"/>
      <stop offset="1" stop-color="#132b3a"/>
    </linearGradient>
    <linearGradient id="helm" x1="0" y1="0" x2="0" y2="1">
      <stop offset="0" stop-color="#9aa8b6"/>
      <stop offset="1" stop-color="#5c6b78"/>
    </linearGradient>
  </defs>
...
/* favicon: крупный кроп головы без микродеталей и текста — читается в 32px */
const svgSmall = `
<svg xmlns="http://www.w3.org/2000/svg" width="512" height="512" viewBox="0 0 512 512">
  <defs>
    <linearGradient id="bg" x1="0" y1="0" x2="1" y2="1">
  ...
  <g transform="translate(256 276) scale(3.6) translate(-60 -78)">
    <path d="M60 6C60 6 22 47 22 84C22 111 39 130 60 130C81 130 98 111 98 84C98 47 60 6 60 6Z" fill="#ff9600"/>
    <path d="M60 52C60 52 38 74 38 95C38 111 48 122 60 122C72 122 82 111 82 95C82 74 60 52 60 52Z" fill="#ffc800"/>
    <path d="M34 66 C24 62 18 52 20 42 C28 46 34 54 36 62 Z" fill="#e8e0d0"/>
    <path d="M86 66 C96 62 102 52 100 42 C92 46 86 54 84 62 Z" fill="#e8e0d0"/>
    <path d="M36 72 C36 56 46 46 60 46 C74 46 84 56 84 72 Z" fill="#77879a"/>
    <rect x="33" y="68" width="54" height="9" rx="4.5" fill="#4a5763"/>
    <rect x="46" y="80" width="9" height="14" rx="4.5" fill="#7a3d00"/>
    <rect x="65" y="80" width="9" height="14" rx="4.5" fill="#7a3d00"/>
    <path d="M50 104 Q60 115 70 104" stroke="#7a3d00" stroke-width="5" stroke-linecap="round" fill="none"/>
  </g>
</svg>`
