...
export const DEFAULT_SETTINGS: Settings = {
  ...
  /* Окно переезда. В приложении стояло 29.07–02.08, в планах вальта
     («Состояние», «Карта пробелов») — 29.07–16.08. С 3 августа приложение
     снова рвало серию за пропуски, хотя план говорит, что не должно. */
