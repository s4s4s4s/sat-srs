  ...
  return (
    <div className="screen">
      ...
      <div className="field">
        ...
        <div className="hint">Включено — половина повторов спрашивает слово вводом, без вариантов. Выключено — остаётся только выбор из четырёх, а его проходят узнаванием: слово растит интервал, ни разу не будучи вспомненным.</div>
      </div>
      <div className="field">
        <label>
          <input
